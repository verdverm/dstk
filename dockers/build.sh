...
# curl http://mirror.reverse.net/pub/apache/hadoop/common/hadoop-2.4.1/hadoop-2.4.1.tar.gz > hadoop/hadoop-2.4.1.tar.gz
...
# curl http://mirror.reverse.net/pub/apache/spark/spark-1.0.2/spark-1.0.2-bin-hadoop2.tgz > spark/spark-1.0.2-bin-hadoop2.tgz
